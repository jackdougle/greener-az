...
export default function CountyDetailsPanel({ county, onClose }: CountyDetailsPanelProps) {
  ...
  const getGridStressColor = (stress: string): string => {
    switch (stress) {
      ...
      case 'Moderate': return 'bg-muted0 text-foreground';
    ...
    <Card className="shadow-xl border-0 bg-card backdrop-blur">
      ...
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 ">
          ...
          <div className="space-y-3 fade-in-up stagger-10">
            <div className="translate-x-10">
            <h4 className="font-semibold text-foreground text-lg">Key Metrics</h4>
            <div className="space-y-2">
              <div className="transition-smooth -mx-2 px-2 py-2 rounded-lg">
          ...
          <div className="space-y-2 fade-in-up stagger-2">
            <h4 className="font-semibold text-foreground text-lg">Sustainability & Energy</h4>
              <div className="transition-smooth -mx-2 px-2 rounded-lg pr-8">
          ...
          <div className="space-y-2 fade-in-up stagger-3">
            <h4 className="font-semibold text-foreground text-lg">Cities & Sources</h4>
              <div className="transition-smooth -mx-2 px-2 rounded-lg">
              ...
              <div className="transition-smooth -mx-2 px-2 py-2 rounded-lg">
                ...
                <div className="space-y-1 mt-1">
                  {county.primary_sources?.slice(0, 3).map((source, index) => {
                    ...
                    return (
                      <div key={index} className={`flex items-center space-x-2 text-xs transition-smooth fade-in stagger-${index + 1}`}>
          ...
          <div className="space-y-3 fade-in-up stagger-4">
            <h4 className="font-semibold text-foreground text-lg">Status & Actions</h4>

              {/* Carbon Footprint Summary */}
              {county.carbonFootprint && (
                <div className="rounded-lg p-2 transition-smooth fade-in stagger-1 max-w-60" style={{ backgroundColor: 'hsl(var(--opportunities-bg))', border: '1px solid hsl(var(--opportunities-border))' }}>
                  ...
                  <div className="text-xs space-y-1">
                    <div className="transition-smooth -mx-1 px-1 py-0.5 rounded">
              ...
              <div className="rounded-lg p-2 max-w-60" style={{ backgroundColor: 'hsl(var(--opportunities-bg))', border: '1px solid hsl(var(--opportunities-border))' }}>
                <div className="flex items-center space-x-1 mb-1">
                ...
                <ul className="text-xs text-foreground/80 space-y-0.5">
                  {county.renewable_percentage < 30 && (
                    <li className="transition-smooth -mx-1 px-1 py-0.5 rounded">• Increase solar capacity</li>
                  )}
                  {county.consumption_per_capita > 15 && (
                    <li className="transition-smooth -mx-1 px-1 py-0.5 rounded">• Energy efficiency programs</li>
                  )}
                  {county.carbon_emissions_tons > 1000000 && (
                    <li className="transition-smooth -mx-1 px-1 py-0.5 rounded">• Transition to renewables</li>
                  )}
                  <li className="transition-smooth -mx-1 px-1 py-0.5 rounded">• Expand solar incentives</li>
                </ul>
              </div>
            </div>
